...
public class SkillReferencePosition {
    ...
    public static String warriorTwinstrike = "4xep9ktz3a23kgmv";
    public static String warriorSwordfall = "l25y43rzg9mp48ju";
    ...
    public static String ascendancyMagicCircle = "w57ptbcf9foj6m24";
    public static String ascendancyArcaneSlash = "ym0s2o1gn8frrrfm";
